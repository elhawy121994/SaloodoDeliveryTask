            ...
            <div class="col-md-4">
                <form @submit.prevent="pickParcel">
                    <div class="form-group">
                        <label>Time</label>
                        <datetime format="YYYY-MM-DD H:i:s" width="300px" v-model="pick_up_at"></datetime>
                    </div>
                    <br>
...
export default {
    ...
    methods: {
        pickParcel() {
            this.axios
                .patch(`http://127.0.0.1:8000/api/v1/bikers/parcels/pick/${this.$route.params.id}`, {"pick_up_at": this.pick_up_at},
